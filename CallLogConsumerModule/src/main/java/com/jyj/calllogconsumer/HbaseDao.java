...
public class HbaseDao {
     ...
     * @return
     */
    public String genRowkey(String hash,String caller,String callerTime,String flag,String callee,String duration){
        return hash + "," + caller + "," + callerTime + "," + flag + "," + callee + "," + duration ;
    }
}